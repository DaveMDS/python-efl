cdef extern from "Elementary.h":
    ...
    void                     elm_image_scale_set(Evas_Object *obj, double scale)
    double                   elm_image_scale_get(const Evas_Object *obj)
    ...
    #void                     elm_image_resize_down_set(Evas_Object *obj, Eina_Bool resize_down)
    #Eina_Bool                elm_image_resize_down_get(const Evas_Object *obj)
    #void                     elm_image_resize_up_set(Evas_Object *obj, Eina_Bool resize_up)
    #Eina_Bool                elm_image_resize_up_get(const Evas_Object *obj)
    void                     elm_image_sizing_eval(Evas_Object *obj)
    ...
    void                     elm_image_fill_inside_set(Evas_Object *obj, Eina_Bool fill_inside)
    Eina_Bool                elm_image_fill_inside_get(const Evas_Object *obj)
