...
cdef extern from "Elementary.h":
    ...
    # TODO: Eina_Bool                elm_toolbar_item_icon_memfile_set(Elm_Object_Item *item, const_char *img, const_char *size, const_char *format, const_char *key)
    ...
    Eina_Bool                elm_toolbar_transverse_expanded_get(const_Evas_Object *obj)
    ...
    Eina_Bool                elm_toolbar_reorder_mode_get(const_Evas_Object *obj)
